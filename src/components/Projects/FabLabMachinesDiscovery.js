  ...
  const machineSimulationSection = (
    <>
      ...
      <Typography className="leading-5 text-justify">
        ...
        <b>"Exit()"</b> from the
        <b>MachineSimulation class</b> that I implemented. Having the same
        structure and calling the same event makes it{" "}
        <b>very easy to play and reset the animation multiple times</b>, as long
        as the user keeps tapping the "Play Simulation" popup.
      </Typography>
